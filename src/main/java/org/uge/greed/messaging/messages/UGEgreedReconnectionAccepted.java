...
public class UGEgreedReconnectionAccepted implements UGEGreedBaseMessage {
    protected UGEGreedOperation operation;
    protected ServerConfig parent ;
    protected ServerConfig joiner ;

    public UGEgreedReconnectionAccepted(ServerConfig parent, ServerConfig joiner){
        this.operation = UGEGreedOperation.RECONECTION_ACCEPTED;
        this.parent = parent;
        this.joiner = joiner;
    }
